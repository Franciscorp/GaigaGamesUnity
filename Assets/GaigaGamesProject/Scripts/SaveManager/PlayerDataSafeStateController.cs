...
/// <summary>
/// Player Save State belongs to []
/// Saves all data from player, information asked and current progress in game
/// </summary>
public class PlayerSafeStateController : BaseState
{
    private bool _isSavable = true;

    public static PlayerSafeStateController Instance;


    public PlayerInformation playerInformation { get; set; }
    public string importedJson;

    public PlayerSafeStateController()
    {
    ...
    {
        var _filepath = Application.persistentDataPath + "/" + Utils.PlayerInformationSaveFilePath;
        try
        {
    ...
    public override string SaveState()
    {
        ...
        if (!_isSavable)
        {
            Debug.LogWarning("[Save.PlayerInformation] It was not possible to save file.");
            return string.Empty;
        }

        return JsonUtility.ToJson(playerInformation, true);
    }
